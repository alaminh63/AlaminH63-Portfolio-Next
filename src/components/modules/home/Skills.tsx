...
export default function Skills() {
    return (
        <div className="flex flex-col items-center justify-center w-full h-full py-10">
            <h3 className="  text-sm mb-2">AREAS OF KNOWLEDGE</h3>
            ...
            <Link href="/about" className="bg-black text-white px-6 py-2 rounded-full   transition-transform transform hover:scale-105">
                See More
            </Link>
        </div>
    );
